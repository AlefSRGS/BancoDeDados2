CREATE DATABASE restaurante; -- Criar o banco de dados

USE DATABASE restaurante; -- Usar o banco de dados
...
CREATE TABLE prato ( -- Tabela prato
    id SERIAL PRIMARY KEY,
    nome VARCHAR(100),
    descricao TEXT,
    valor NUMERIC(10, 2),
...
CREATE TABLE ingredientes ( -- Tabela ingredientes
    id SERIAL PRIMARY KEY,
    nome VARCHAR(100),
...
CREATE TABLE usos ( -- Tabela usos (relaciona prato com seus ingrediente)
    id_prato INT,
    id_ingrediente INT,
...
CREATE TABLE venda ( -- Tabela venda
    id SERIAL PRIMARY KEY,
